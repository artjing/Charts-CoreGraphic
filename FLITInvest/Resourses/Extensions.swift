...
extension UIColor {
    static let barDeselectedColor = UIColor(white: 0, alpha: 0.3)
}
...
extension UIViewController {
    ...
    func configureGradientLayer() {
        let topColor = UIColor(rgb: 0x162035)
        let middleColor = UIColor(rgb: 0x44719A)
        let bottomColor = UIColor(rgb: 0xA2BAD3)
