//
//  FLITRegisterConfirmPortfolioLastViewController.swift
//  FLITInvest
//
//  Created by 董静 on 9/13/21.
//

import UIKit

class FLITRegisterConfirmPortfolioLastViewController: FLITRegistrationBaseViewController {
